...
L["ENH_LOGIN_MSG_WRATH"] = "您正在使用 |cff1784d1ElvUI Enhanced (Yet) Again|r |cffff8000(巫妖王經典版)|r 版本 %s%s|r."
L["MSG_EEL_ELV_OUTDATED"] = "您的ElvUI版本低於 |cff1784d1ElvUI Enhanced (Yet) Again|r 的建議版本。您的版本是 |cff1784d1%.2f|r (建議版本: |cff1784d1%.2f|r)。請更新ElvUI。"
...
L["Miscellaneous"] = "雜項"
L['Equipment Set Overlay'] = "裝備模組覆蓋"
...
L['Hide Role Icon in combat'] = "戰鬥中隱藏角色定位圖示"
L['All role icons (Damage/Healer/Tank) on the unit frames are hidden when you go into combat.'] = "戰鬥中隱藏單位框架上的所有角色定位圖示(傷害/治療/坦克)."
...
-- Class Icon
L['Show class icon for units.'] = "顯示職業圖標."

-- Minimap Location
L["MiniMap Coordinates"] = "小地圖座標"
...
L['Normal is right to left or top to bottom, or select reversed to switch directions.'] = "正常為從右到左或從上到下，選擇反轉可切換方向."
L['Normal'] = "正常"
L['Reversed'] = "反轉"
...
L["Target Count"] = "目標計數"
L["Display the number of party / raid members targetting the nameplate unit."] = "在血條旁邊顯示隊伍/團隊成員中以其為目標的個數."
...
L["Glow Duration"] = "高亮持續時間"
L["The amount of time the unit frames of party / raid members will glow when affected by a direct AoE heal."] = "當隊伍/團隊成員受到直接性範圍治療法術時高亮持續的時間."
L["Glow Color"] = "高亮顏色"
...
-- WatchFrame
L['WatchFrame'] = "追蹤器"
L['WATCHFRAME_DESC'] = "調整追蹤器(任務日誌)的可見性設定."
L['Hidden'] = "隱藏"
L['Collapsed'] = "收起"
L['Settings'] = "設定"
...
L['Display the players raid progression in the tooltip, this may not immediately update when mousing over a unit.'] = "在提示框中顯示玩家的副本進度，滑鼠移到目標上時可能不會立即更新."
