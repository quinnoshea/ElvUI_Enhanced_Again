...
-- Init
L["ENH_LOGIN_MSG"] = "Sie verwenden |cff1784d1ElvUI Enhanced (Yet) Again|r |cffff8000(Retail)|r Version %s%s|r."
L["ENH_LOGIN_MSG_WRATH"] = "Sie verwenden |cff1784d1ElvUI Enhanced (Yet) Again|r |cffff8000(Wrath Classic)|r Version %s%s|r."
L["MSG_EEL_ELV_OUTDATED"] = "Ihre Version von ElvUI ist älter als für die Verwendung mit |cff1784d1ElvUI Enhanced (Yet) Again|r empfohlen. Ihre Version ist |cff1784d1%.2f|r (empfohlen ist |cff1784d1%.2f|r). Bitte aktualisieren Sie Ihre ElvUI."
...
L["Changes the transparency of all the movers."] = "Konfiguriere die Einstellungen der Transparenz der Ankerpunkte."
...
-- Minimap Location
L["MiniMap Coordinates"] = "Minimap-Koordinaten"
...
-- Minimap Buttons
L["Minimap Button Bar"] = "Minimap-Buttonleiste"
...
L['Layout Direction'] = "Layoutrichtung"
L['Normal is right to left or top to bottom, or select reversed to switch directions.'] = "Normal ist rechts nach links oder oben nach unten. Wählen Sie umgekehrt, um die Richtung zu wechseln."
L['Normal'] = "Normal"
...
L['Automatically change your watched faction on the reputation bar to the faction you got reputation points for.'] = "Ändere automatisch die beobachtete Fraktion auf der Erfahrungsleiste zu der Fraktion für die Sie gerade Rufpunkte erhalten haben."
...
L['Display the players raid progression in the tooltip, this may not immediately update when mousing over a unit.'] = 'Zeigt den Schlachtzugfortschritt eines Charakters im Tooltip an. Es kann einen kurzen Moment dauern, bis diese Information angezeigt / aktualisiert wird.'
